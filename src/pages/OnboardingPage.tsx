    ...
    try {
      ...
      if (useTemplate) {
        await supabase.from('categories').insert([
          ...
          { household_id: household.id, name: 'Trasporti', type: 'expense', sort_order: 3 },
          { household_id: household.id, name: 'Abbigliamento', type: 'expense', sort_order: 4 },
          { household_id: household.id, name: 'Tempo libero', type: 'expense', sort_order: 5 },
          { household_id: household.id, name: 'Cura della persona', type: 'expense', sort_order: 6 },
          { household_id: household.id, name: 'Assicurazione', type: 'expense', sort_order: 7 },
          { household_id: household.id, name: 'Imposte', type: 'expense', sort_order: 8 },
          { household_id: household.id, name: 'Regali e beneficenza', type: 'expense', sort_order: 9 },
          { household_id: household.id, name: 'Risparmi', type: 'expense', sort_order: 10 },
          { household_id: household.id, name: 'Prestiti', type: 'expense', sort_order: 11 },
          { household_id: household.id, name: 'Spesa', type: 'expense', sort_order: 99 },

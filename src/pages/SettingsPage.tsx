...
import {
  ...
  verifyGoogleDriveAutomaticRenewal,
...
export const SettingsPage: React.FC = () => {
  ...
  const connectGoogleDrive = useCallback(async (requestConsentIfNeeded: boolean) => {
    ...
    try {
      ...
      await verifyGoogleDriveAutomaticRenewal();
      ...
      setStorageMessage(`Google Drive personale collegato, upload verificato e rinnovo automatico attivo. I tuoi nuovi scontrini andranno nella cartella ${folder.name}.`);

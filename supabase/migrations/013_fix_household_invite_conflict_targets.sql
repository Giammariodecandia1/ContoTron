-- Avoid PL/pgSQL ambiguity between output column names and insert conflict targets.
-- Using the explicit unique constraint keeps invite joins and email member adds stable.
...
begin
  ...
  where hm.user_id = target_profile.id
...
begin
  ...
  where hm.user_id = auth.uid()
    and hm.household_id <> target_household.id;
